 ...
 * @author ASUS
 */
@WebServlet(name = "updateproductprice", urlPatterns = {"/updateproductprice.do"})
public class updateproductprice extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
       ...
       int price=Integer.parseInt(request.getParameter("PRICE"));
        ...
        int productId = db.getProduct(request.getParameter("Product"));
        
        int count=db.updateproductprice(productId,price);
        if(count!=0){
